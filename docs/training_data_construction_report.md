...
- `6362403辛秉太` (2 samples)
- `6667609雷传坤` (2 samples)
- `6670101高兴元` (2 samples)
- `6803240孙红` (2 samples)
- `6878124景丙合` (2 samples)
- `8185756张桂平` (2 samples)
- `8232517孔繁舜` (2 samples)
- `8235083张修华` (2 samples)
- `8240576宋文林` (2 samples)
- `8249423杨齐胜` (2 samples)
- `8249671孙贵凤` (2 samples)
- `8251229袁进涛` (2 samples)
- `8251361谢广亮` (2 samples)
- `8251646包有江` (2 samples)
- `8252224 崔炳琦` (2 samples)
- `8252701王守平` (2 samples)
- `8252799王忠永` (2 samples)
- `8252876 张友平` (2 samples)
- `8253150李忠成` (2 samples)
- `8253290丁巧莲` (2 samples)
- `8253599张见美` (2 samples)
- `8253667位静` (2 samples)
- `8253973杨学轩` (2 samples)
- `8254964魏义珍` (2 samples)
- `8255988杨娜` (2 samples)
- `8257914安令兰` (2 samples)
- `8259656李胡氏` (2 samples)
- `8259809石川` (2 samples)
- `8260019杨秀清` (2 samples)
...
The builder now logs **29 raw source issues** in `datasets/full_data/source_issues.csv`. These issues reflect source-data completeness and residual naming problems that still cannot be parsed structurally.
